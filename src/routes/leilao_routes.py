...
from .. import db
from ..controllers.leilao_controller import get_filter, create, delete, update

leilao = Blueprint('leilao', __name__)


@leilao.route('/leilao', methods=['GET'])
def get_filter_leilao(): return get_filter(request.args.get('idtipo', None), request.args.get('nome', None))
